...
public class ExportFileServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Iterate through Enumeration of parameter names from the request object and put inside paramsMap each parameter send from request
        ...
        while (enumeration.hasMoreElements()) {
            ...
            paramsMap.put(parameterName,request.getParameterValues("parameterName"));
        }
        ...
        try (InputStream reportStream = getClass().getResourceAsStream(jasperPath)) {
            ...
            String result = ""+passedTemplate+"."+passedFileType;
            response.setHeader("Content-Language", "Content-Disposition: attachment " + result);
