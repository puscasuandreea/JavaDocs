...
public class MyList<Integer> extends ArrayList<Integer> {
    ...
    public boolean addAll(Collection<? extends Integer> c) {
        ...
        Iterator<Integer> itera = (Iterator<Integer>) c.iterator();
            while(itera.hasNext()){
                Integer lista = itera.next();
                if(!super.contains(lista)){
                    differentElements++;
                }
            }
    ...
    public boolean addAll(int index, Collection<? extends Integer> c) {
        ...
        Iterator<Integer> itera1 = (Iterator<Integer>) c.iterator();
            while (itera1.hasNext()){
                Integer lista1 = itera1.next();
                if(!super.contains(lista1))
                    differentElements++;
            }
    ...
    public Integer remove(int index) {
        ...
        Integer delete1 = super.remove(index);
