...
public class Student {
    ...
    public String toString() {
        return "id"+ this.id + "First Name:" + this.firstName + "Last Name:"+ this.lastName + "Average Grade "+ this.averageGrade;
    }
    ...
    public boolean equals(Object o) {
        ...
        //  Exercise 2 c5) Object o (id, lastName, firstName, averageGrade)
               ...
               if(this.lastName.equals(st.lastName)== false){
                   return  false;
               }
               if(this.firstName.equals((st.firstName))== false){
                   return  false;
               }
               if(this.averageGrade.equals(st.averageGrade)== false){
                   return false;
               }
        return true;
